...
$hovercraft_title_row_classes = array( 'checkout-title-row' );

if ( $h1_divider_display === 'everywhere_possible' || $h1_divider_display === 'everywhere_except_heros' ) {
	$hovercraft_title_classes[] = 'divide';
	$hovercraft_title_row_classes[] = 'divide';
}

?>
<div class="<?php echo esc_attr( implode( ' ', $hovercraft_title_row_classes ) ); ?>">
