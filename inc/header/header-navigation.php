...
function hovercraft_header_cart_icon() {
	...
	<div class="cart-icon-wrapper">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" aria-label="<?php echo esc_attr__( 'View cart', 'hovercraft' ); ?>">
			<?php if ( 'material_icons_classic' === $header_icon_style ) : ?>
		...
		<div class="notification-dot" aria-hidden="true"><?php echo esc_html( $cart_count ); ?></div><!-- notification-dot -->
