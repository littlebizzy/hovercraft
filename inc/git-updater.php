...
function hovercraft_suggest_git_updater_plugin() {
    ...
    if ( file_exists( $git_updater ) && ! in_array( 'git-updater/git-updater.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) { ?>
    ...
    <?php } elseif ( ! file_exists( $git_updater ) ) { ?>
