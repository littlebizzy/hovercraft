...
function hovercraft_generate_css(){
	...
	$h2_mobile_font_size = get_theme_mod( 'hovercraft_h2_mobile_font_size', '24' );
	$h2_desktop_font_size = get_theme_mod( 'hovercraft_h2_desktop_font_size', '48' );
	...
	$h3_desktop_font_size = get_theme_mod( 'hovercraft_h3_desktop_font_size', '48' );
	$h3_font_weight = get_theme_mod( 'hovercraft_h3_font_weight', '700' );
	$h4_font_family = get_theme_mod( 'hovercraft_h4_font', 'noto_sans' );
	$h4_mobile_font_size = get_theme_mod( 'hovercraft_h4_mobile_font_size', '24' );
	$h4_desktop_font_size = get_theme_mod( 'hovercraft_h4_desktop_font_size', '48' );
	$h4_font_weight = get_theme_mod( 'hovercraft_h4_font_weight', '700' );
	$h5_font_family = get_theme_mod( 'hovercraft_h5_font', 'noto_sans' );
	$h5_mobile_font_size = get_theme_mod( 'hovercraft_h5_mobile_font_size', '24' );
	$h5_desktop_font_size = get_theme_mod( 'hovercraft_h5_desktop_font_size', '48' );
