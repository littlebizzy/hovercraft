...
$wp_customize->add_control( new WP_Customize_Control(
    ...
    array(
        ...
        'choices' => array(
            'none' => 'None',
            'full_only' => 'Full Hero Only',
            'half_only' => 'Half Hero Only',
            'mini_only' => 'Mini Hero Only',
            'basic_only' => 'Basic Header Only',
            'full_and_half' => 'Full + Half Hero',
            'full_and_mini' => 'Full + Mini Hero',
            'full_and_basic' => 'Full Hero + Basic Header',
            'half_and_mini' => 'Half + Mini Hero',
            'half_and_basic' => 'Half Hero + Basic Header',
            'mini_and_basic' => 'Mini Hero + Basic Header',
            'full_half_mini' => 'Full + Half + Mini Hero',
            'full_half_basic' => 'Full + Half Hero + Basic Header',
            'full_mini_basic' => 'Full + Mini Hero + Basic Header',
            'half_mini_basic' => 'Half + Mini Hero + Basic Header',
            'full_half_mini_basic' => 'Full + Half + Mini Hero + Basic Header',
        ),
    )
) );
