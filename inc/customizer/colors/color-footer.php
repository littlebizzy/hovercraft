...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_prefooter_top_colors',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_prefooter_bottom_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_footer_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_footer_callout_background_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_footer_callout_border_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_footer_callout_text_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_footer_callout_link_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_copyright_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_back_to_top',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
