...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_default_link_colors',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_default_hover_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_hero_snippet_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_hero_snippet_text_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_hero_snippet_link_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_breadcrumbs_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_breadcrumbs_text_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_breadcrumbs_link_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_search_bar_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_search_bar_background_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_search_bar_border_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_search_input_placeholder_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_search_input_text_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_heading_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_title_divider_background_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_blockquote_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_blockquote_text_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_blockquote_border_color',
	array(
...
$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'hovercraft_divider_woocommerce_price_colors',
	array(
		'description' => '<hr style="margin: 16px 0; border: 0; border-top: 2px solid #ddd;">',
		'type' => 'hidden',
		'section' => 'colors',
...
$wp_customize->add_control( new WP_Customize_Color_Control(
	$wp_customize,
	'hovercraft_woocommerce_price_text_color',
	array(
